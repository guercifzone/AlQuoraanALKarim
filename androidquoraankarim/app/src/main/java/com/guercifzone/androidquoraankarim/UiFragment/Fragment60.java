...
public class Fragment60 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_60.Section> sections = Quoraan_60.readJsonFile(requireContext());
        for (Quoraan_60.Section section : sections) {
