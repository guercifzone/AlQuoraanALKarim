...
public class Fragment66 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_66.Section> sections = Quoraan_66.readJsonFile(requireContext());
        for (Quoraan_66.Section section : sections) {
