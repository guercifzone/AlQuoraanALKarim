...
public class Fragment73 extends Fragment {
    //سورة الفاتحة
    public Fragment73(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_73.Section> sections = Quoraan_73.readJsonFile(requireContext());
        for (Quoraan_73.Section section : sections) {
