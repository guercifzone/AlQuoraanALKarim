...
public class Fragment77 extends Fragment {
    //سورة الفاتحة
    public Fragment77(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_77.Section> sections = Quoraan_77.readJsonFile(requireContext());
        for (Quoraan_77.Section section : sections) {
