...
public class Fragment88 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_88.Section> sections = Quoraan_88.readJsonFile(requireContext());
        for (Quoraan_88.Section section : sections) {
