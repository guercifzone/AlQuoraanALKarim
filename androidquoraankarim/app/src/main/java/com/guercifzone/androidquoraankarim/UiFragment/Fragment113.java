...
public class Fragment113 extends Fragment {
    //سورة الفاتحة
    public Fragment113(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_113.Section> sections = Quoraan_113.readJsonFile(requireContext());
        for (Quoraan_113.Section section : sections) {
