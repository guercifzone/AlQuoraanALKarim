...
public class Fragment64 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_64.Section> sections = Quoraan_64.readJsonFile(requireContext());
        for (Quoraan_64.Section section : sections) {
