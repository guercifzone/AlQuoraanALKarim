...
public class Fragment67 extends Fragment {
    //سورة الفاتحة
    public Fragment67(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_67.Section> sections = Quoraan_67.readJsonFile(requireContext());
        for (Quoraan_67.Section section : sections) {
