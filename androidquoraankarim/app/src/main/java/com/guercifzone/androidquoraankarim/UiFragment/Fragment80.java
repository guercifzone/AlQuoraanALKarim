...
public class Fragment80 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_80.Section> sections = Quoraan_80.readJsonFile(requireContext());
        for (Quoraan_80.Section section : sections) {
