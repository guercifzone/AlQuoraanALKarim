...
public class Fragment98 extends Fragment {
    //سورة الفاتحة
    public Fragment98(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_98.Section> sections = Quoraan_98.readJsonFile(requireContext());
        for (Quoraan_98.Section section : sections) {
