...
public class Fragment74 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_74.Section> sections = Quoraan_74.readJsonFile(requireContext());
        for (Quoraan_74.Section section : sections) {
