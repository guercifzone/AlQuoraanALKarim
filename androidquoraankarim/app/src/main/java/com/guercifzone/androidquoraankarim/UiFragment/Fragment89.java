...
public class Fragment89 extends Fragment {
    //سورة الفاتحة
    public Fragment89(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_89.Section> sections = Quoraan_89.readJsonFile(requireContext());
        for (Quoraan_89.Section section : sections) {
