...
public class Fragment54 extends Fragment {
    //سورة الفاتحة
    public Fragment54(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_54.Section> sections = Quoraan_54.readJsonFile(requireContext());
        for (Quoraan_54.Section section : sections) {
