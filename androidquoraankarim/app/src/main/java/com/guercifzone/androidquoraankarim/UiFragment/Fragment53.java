...
public class Fragment53 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_53.Section> sections = Quoraan_53.readJsonFile(requireContext());
        for (Quoraan_53.Section section : sections) {
