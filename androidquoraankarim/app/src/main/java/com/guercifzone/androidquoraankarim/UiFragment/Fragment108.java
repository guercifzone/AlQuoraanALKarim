...
public class Fragment108 extends Fragment {
    //سورة الفاتحة
    public Fragment108(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_108.Section> sections = Quoraan_108.readJsonFile(requireContext());
        for (Quoraan_108.Section section : sections) {
