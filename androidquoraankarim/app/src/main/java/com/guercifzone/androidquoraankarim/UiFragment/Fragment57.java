...
public class Fragment57 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_57.Section> sections = Quoraan_57.readJsonFile(requireContext());
        for (Quoraan_57.Section section : sections) {
