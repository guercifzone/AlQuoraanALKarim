...
public class Fragment76 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_76.Section> sections = Quoraan_76.readJsonFile(requireContext());
        for (Quoraan_76.Section section : sections) {
