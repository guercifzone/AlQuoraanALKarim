...
public class Fragment78 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_78.Section> sections = Quoraan_78.readJsonFile(requireContext());
        for (Quoraan_78.Section section : sections) {
