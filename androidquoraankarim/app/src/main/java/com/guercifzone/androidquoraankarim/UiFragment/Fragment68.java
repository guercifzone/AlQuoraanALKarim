...
public class Fragment68 extends Fragment {
    //سورة الفاتحة
    public Fragment68(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_68.Section> sections = Quoraan_68.readJsonFile(requireContext());
        for (Quoraan_68.Section section : sections) {
