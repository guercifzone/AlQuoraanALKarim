...
public class Fragment84 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_84.Section> sections = Quoraan_84.readJsonFile(requireContext());
        for (Quoraan_84.Section section : sections) {
