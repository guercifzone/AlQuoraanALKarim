...
public class Fragment59 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_59.Section> sections = Quoraan_59.readJsonFile(requireContext());
        for (Quoraan_59.Section section : sections) {
