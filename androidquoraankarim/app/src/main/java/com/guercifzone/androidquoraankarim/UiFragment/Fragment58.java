...
public class Fragment58 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_58.Section> sections = Quoraan_58.readJsonFile(requireContext());
        for (Quoraan_58.Section section : sections) {
