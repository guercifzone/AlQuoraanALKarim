...
public class Fragment86 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_86.Section> sections = Quoraan_86.readJsonFile(requireContext());
        for (Quoraan_86.Section section : sections) {
