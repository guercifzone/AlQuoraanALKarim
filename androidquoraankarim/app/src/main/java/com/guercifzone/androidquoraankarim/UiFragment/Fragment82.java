...
public class Fragment82 extends Fragment {
    //سورة الفاتحة
    public Fragment82(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_82.Section> sections = Quoraan_82.readJsonFile(requireContext());
        for (Quoraan_82.Section section : sections) {
