...
public class Fragment83 extends Fragment {
    //سورة الفاتحة
    public Fragment83(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_83.Section> sections = Quoraan_83.readJsonFile(requireContext());
        for (Quoraan_83.Section section : sections) {
