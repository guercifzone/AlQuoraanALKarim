...
public class Fragment104 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_104.Section> sections = Quoraan_104.readJsonFile(requireContext());
        for (Quoraan_104.Section section : sections) {
