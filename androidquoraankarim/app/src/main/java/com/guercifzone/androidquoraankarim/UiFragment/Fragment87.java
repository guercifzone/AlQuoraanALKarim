...
public class Fragment87 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_87.Section> sections = Quoraan_87.readJsonFile(requireContext());
        for (Quoraan_87.Section section : sections) {
