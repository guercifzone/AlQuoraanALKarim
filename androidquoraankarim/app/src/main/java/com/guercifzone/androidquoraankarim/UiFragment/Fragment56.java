...
public class Fragment56 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_56.Section> sections = Quoraan_56.readJsonFile(requireContext());
        for (Quoraan_56.Section section : sections) {
