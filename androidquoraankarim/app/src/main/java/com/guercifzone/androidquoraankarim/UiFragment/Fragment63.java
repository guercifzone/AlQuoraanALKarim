...
public class Fragment63 extends Fragment {
    //سورة الفاتحة
    public Fragment63(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_63.Section> sections = Quoraan_63.readJsonFile(requireContext());
        for (Quoraan_63.Section section : sections) {
