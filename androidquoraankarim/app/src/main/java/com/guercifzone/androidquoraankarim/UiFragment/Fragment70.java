...
public class Fragment70 extends Fragment {
    //سورة الفاتحة
    public Fragment70(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_70.Section> sections = Quoraan_70.readJsonFile(requireContext());
        for (Quoraan_70.Section section : sections) {
