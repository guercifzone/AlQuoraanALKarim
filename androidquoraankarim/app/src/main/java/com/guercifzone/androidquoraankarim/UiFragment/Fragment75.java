...
public class Fragment75 extends Fragment {
    //سورة الفاتحة
    public Fragment75(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_75.Section> sections = Quoraan_75.readJsonFile(requireContext());
        for (Quoraan_75.Section section : sections) {
