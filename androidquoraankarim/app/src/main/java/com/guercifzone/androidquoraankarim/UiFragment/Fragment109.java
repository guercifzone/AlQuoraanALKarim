...
public class Fragment109 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_109.Section> sections = Quoraan_109.readJsonFile(requireContext());
        for (Quoraan_109.Section section : sections) {
