...
public class Fragment107 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_107.Section> sections = Quoraan_107.readJsonFile(requireContext());
        for (Quoraan_107.Section section : sections) {
