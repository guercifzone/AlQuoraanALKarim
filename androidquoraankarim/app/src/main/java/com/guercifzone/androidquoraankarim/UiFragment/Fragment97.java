...
public class Fragment97 extends Fragment {
    //سورة الفاتحة
    public Fragment97(){}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_97.Section> sections = Quoraan_97.readJsonFile(requireContext());
        for (Quoraan_97.Section section : sections) {
