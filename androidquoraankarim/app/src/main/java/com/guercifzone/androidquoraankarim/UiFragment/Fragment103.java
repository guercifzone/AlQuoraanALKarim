...
public class Fragment103 extends Fragment {
    //سورة 
...
private float scaleFactor = 1.0f;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<Quoraan_103.Section> sections = Quoraan_103.readJsonFile(requireContext());
        for (Quoraan_103.Section section : sections) {
